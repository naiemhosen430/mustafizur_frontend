  ...
  return (
    <>
      <Swiper
        ...
        onSwiper={(swiper) => {}}
      >
        <SwiperSlide className="text-white rounded-xl inline-block cursor-pointer bg-slate-800 py-10 px-15 text-center">
          <h1 className="text-2xl">Food</h1>
          <p className="text-slate-500 py-2">
            Here is amazing food collaction.
          </p>
        </SwiperSlide>
        <SwiperSlide className="text-white rounded-xl inline-block cursor-pointer bg-slate-800 py-10 px-15 text-center">
          <h1 className="text-2xl">Shoes</h1>
          <p className="text-slate-500 py-2">
            Here is amazing Shoes collaction.
          </p>
        </SwiperSlide>
        <SwiperSlide className="text-white rounded-xl inline-block cursor-pointer bg-slate-800 py-10 px-15 text-center">
